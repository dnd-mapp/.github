...
var merge_release_branch_exports = {};
__export(merge_release_branch_exports, {
  run: () => run
});
module.exports = __toCommonJS(merge_release_branch_exports);
